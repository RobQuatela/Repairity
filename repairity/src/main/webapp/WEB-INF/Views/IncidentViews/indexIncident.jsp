			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="/repairity/incident/">Incidents <span class="sr-only">(current)</span></a>
					</li>
					<li class="nav-item"><a class="nav-link"
						href="/repairity/employee/">Employees</a></li>
				</ul>
			</div>
			</nav>
		</div>
				...
				<div id="displayIncident">
					...
					<div class="row" id="rowDisplayIncident">
						...
						<div class="col-8" style="overflow-y: auto; max-height: 600px;">
							<div class="row" id="rowDisplayIncidentHeader">
								<div class="col-6 text-white" style="background: #6CBEFD;">
									<h1 class="display-4" id="editId"></h1>
								</div>
								<div class="col-2 d-flex align-items-center"
									style="background: #6CBEFD;">
 									<button class="btn" id="btnAssignEmployees"
										style="background-color: transparent;">
										<i class="material-icons" id="btnAssignEmployees" style="font-size: 45px;">person_add</i>
 									</button>
								</div>
								<div class="col-2 d-flex align-items-center"
									style="background: #6CBEFD;">
<!-- 									<button class="btn" id="btnUpdateIncident"
										style="background: #FAFDFF;"> -->
										<i class="material-icons" id="btnUpdateIncident" style="font-size: 45px;">save</i>
<!-- 									</button> -->
								</div>
								<div class="col-2 d-flex align-items-center"
									style="background: #6CBEFD;">
<!-- 									<button class="btn" id="btnLogActivity"
										style="background: #FAFDFF;"> -->
										<i class="material-icons" id="btnLogActivity" style="font-size: 45px;">assignment</i>
<!-- 									</button> -->
								</div>
							</div>
							<br />
				...
				<div id="newIncident">
					<div class="row mb-4">
						...
						<div class="col-2">
							<button class="btn btn-success pull-right" id="btnAddIncident">
								<i class="material-icons" style="font-size: 80px;">check</i>
							</button>
						</div>
						<div class="col-2">
							<button class="btn btn-danger pull-right"
								id="btnCancelAddIncident">
								<i class="material-icons" style="font-size: 80px;">cancel</i>
							</button>
						</div>
					</div>
					<div class="row">
	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 container-fluid">
			<footer class="footer">
			<p class="text-center">
				<br /> Copyright &copy; - Repairity
	...
	<script>
		$(document).ready(function() {
			...
			$("#btnCancelAddIncident").click(function(event) {
		...
		function newIncident() {
			...
			$.ajax({
				...
				success : function(data) {
					...
					$("#displayIncident").show();
					listViaAjax();
					displayMessage("row alert alert-success", data.id + " has been successfully added!", "successUpdate", 2000);
				},
				error : function(error, xhr) {
					displayMessage("row alert alert-success", "ERROR: could not add new incident: " + error, "newIncidentMessage", 5000);
				}
			});
		}
